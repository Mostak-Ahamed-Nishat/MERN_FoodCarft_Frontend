...
const CuisineFilter = ({
  ...
  return (
    <>
      ...
      {/* <div className="space-y-2 flex flex-col flex-row flex-wrap md:flex-col md:flex-nowrap"> */}
            ...
            return (
              <div className="flex">
                ...
                <Label
                  ...
                  className={`flex flex-1 items-center cursor-pointer text-sm rounded-full px-4 py-2 md:py-2 font-semibold ${
                    isSelected
